...
public class ExemploList {
    ...
    public static void main(String[] args) {
        ...
        // List<Double> notas = new ArrayList<Double>(); //Generics e Diamond Operator
        // ArrayList<Double> notas = new ArrayList<>(); //Não é recomendável
        // List<Double> notas = new ArrayList<>(Arrays.asList(7d, 8.5, 9.3, 5d, 7d, 0d, 3.6));
        // List<Double> notas = Arrays.asList(7d, 8.5, 9.3, 5d, 7d, 0d, 3.6); //Não pode adicionar ou remover
        // notas.add(10d);
        // List<Double> notas = List.of(7d, 8.5, 9.3, 5d, 7d, 0d, 3.6); //Não pode adicionar ou remover
        // notas.add(10d);
        // notas.remove(5d);
